...
class TestTowerTerminationSync(unittest.TestCase):

    base_url = EnvConfig.get_base_url()
    BASE_URL = f"{base_url}/crm/towerTerminationSync"
    # BASE_URL = "http://120.52.40.45:48080/crm/towerTerminationSync"   #接口地址
    headers = {
        "Content-Type": "application/xml",
        "Accept": "application/xml"
    }
    def test_towerTerminationSync_YD(self):
        ...
        expected_request_xml = (
            ...
            '<PACKET>'
            '<HEAD>'
            f'<ACCESS_TOKEN>{TokenGenerator.generate_access_token("1001", "T09_TO_019")}</ACCESS_TOKEN>'
        ...
        #     '<CUST_COMPANY>1001</CUST_COMPANY>'
        #     '<SERVICE_CODE>T09_TO_019</SERVICE_CODE>'
        #     '<RESPONSE_TIME>2025-05-27 14:01:00</RESPONSE_TIME>'
        #     '<RESPONSE_CODE>000000</RESPONSE_CODE>'
        #     '</HEAD>'
        #     '<BODY>'
        #     '<REQUEST_ID>1116013102565221</REQUEST_ID>'
    ...
    def test_towerTerminationSync_DX(self):
        ...
        #     '</HEAD>'
        #     '<BODY>'
        #     '<REQUEST_ID>1116013103262389</REQUEST_ID>'
        #     '<SYNC_RESULT>1</SYNC_RESULT>'
        #     '<FAIL_MESSAGE>1</FAIL_MESSAGE>'
        #     '</BODY>'
        #     '</PACKET>'
        # )
        try:
    ...
    def test_towerTerminationSync_LT(self):
    ...
    def test_towerTerminationSync_lackServiceCode(self):
    ...
    def test_towerTerminationSync_lackRequestTime(self):
    ...
    def test_towerTerminationSync_otherServiceCode(self):
        ...
        expected_request_xml = (
            ...
            f'<ACCESS_TOKEN>{TokenGenerator.generate_access_token("1002", "T09_TO_019")}</ACCESS_TOKEN>'
            '<CUST_COMPANY>1002</CUST_COMPANY>'
            '<SERVICE_CODE>T09_TO_018</SERVICE_CODE>'
            f'<REQUEST_TIME>{GetCurrentTime.get_current_time()}</REQUEST_TIME>'
            '</HEAD>'
            '<BODY>'
            '<REQUEST_ID>1234123123112113</REQUEST_ID>'
