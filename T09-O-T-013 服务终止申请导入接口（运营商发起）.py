...
class CustomerTerminationImportOT(unittest.TestCase):
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.SERVICE_CODE = "T09_OT_013"  # 服务代码
    ...
    def build_soap_envelope(self, request_xml):
        ...
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" 
           ...
           <soapenv:Header/>
           <soapenv:Body>
              <web:CustomerTerminationImportOT>
    ...
    def test_CustomerTerminationImportOT_LT(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
    ...
    def test_CustomerTerminationImportOT_lackToken(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
        request_xml = self.generate_request_xml(cust_company=self.CUST_COMPANY,
                                                service_code=self.SERVICE_CODE,
    ...
    def test_CustomerTerminationImportOT_lackCustCompany(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
    ...
    def test_CustomerTerminationImportOT_lackServiceCode(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
        request_xml = self.generate_request_xml(cust_company=self.CUST_COMPANY,
                                                service_code="",
    ...
    def test_CustomerTerminationImportOT_lackRequestTime(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
        request_xml = self.generate_request_xml(cust_company=self.CUST_COMPANY,
                                                service_code=self.SERVICE_CODE,
    ...
    def test_CustomerTerminationImportOT_errorToken(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
        request_xml = self.generate_request_xml(cust_company=self.CUST_COMPANY,
                                                service_code=self.SERVICE_CODE,
    ...
    def test_CustomerTerminationImportOT_otherServiceCode(self):
        """铁塔终止确认SOAP接口测试"""
        # 1. 准备测试数据
        request_xml = self.generate_request_xml(cust_company=self.CUST_COMPANY,
                                                service_code='T09_OT_014',
                                                access_token=TokenGenerator.generate_access_token(self.CUST_COMPANY, self.SERVICE_CODE),
                                                request_time=GetCurrentTime.get_current_time()).strip()
        request_xml_decode = Base64Util.encode_string(request_xml)
        soap_request = self.build_soap_envelope(request_xml_decode)
