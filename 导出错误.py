...
class TestGetExportErr(unittest.TestCase):
    ...
    def public_request(self,param):
        ...
        try:
            response = requests.get(
                url=f'{EnvConfig.get_base_url()}/report/exportErr',
                params=param,
                timeout=10
            )
    ...
    获取统计明细
    '''
    def test_getExportErr_all_param(self):
        """
        全部参数查询
        :return:
        """
    ...
    def getExportErr_empty_pram(self,data,pramname,param_type):
        """
        必填参数为空通用查询
        :return:
        """
    ...
    def test_getExportErr_empty_provinceCode(self):
        params = {
            'provinceId': '',
            'cityId': '',
            'accountPeriod': '',
        ...
        self.getExportErr_empty_pram(params,'provinceCode','empty')
