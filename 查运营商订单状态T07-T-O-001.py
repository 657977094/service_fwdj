...
class TestOrderStatusQueryTO(unittest.TestCase):
    ...
    BASE_URL = f"{base_url}/crm/orderStatusQueryTO"
    # BASE_URL = "http://120.52.40.45:48080/crm/orderStatusQueryTO"   #接口地址
    headers = {
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.SERVICE_CODE = "T07_TO_001"  # 服务代码
    ...
    def generate_request_xml(self,cust_company,service_code,access_token,request_time):
        ...
        return (
            ...
            '<REQUEST_TIME>2025-05-01 00:00:00</REQUEST_TIME>'
            '<PROCESS_TYPE>02</PROCESS_TYPE>'
            '</BODY>'
            '</PACKET>'
        )
    ...
    def test_orderStatusQueryTO_DX(self):
        ...
        #     '<SERVICE_CODE>T07_TO_001</SERVICE_CODE>'
