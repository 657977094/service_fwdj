...
class TestDemandChangeConfirmAfterRent(unittest.TestCase):

    base_url = EnvConfig.get_base_url()
    BASE_URL = f"{base_url}/crm/demandChangeConfirmAfterRent"
    # BASE_URL = "http://120.52.40.45:48080/crm/demandChangeConfirmAfterRent"   #接口地址
    headers = {
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.SERVICE_CODE = "T03_TO_017"  # 服务代码
    ...
    def test_demandChangeApplyAfterRent_DX(self):
        ...
        #     '<SERVICE_CODE>T03_TO_017</SERVICE_CODE>'
